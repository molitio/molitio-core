...
export const SpeakerBackgroundPlayerSvg: React.FC<SvgComponentProps> = ({ ...props }) => {
    ...
    /* 
       <style type="text/css" id="style824-5">
 ...
 */
    ...
    return (
        ...
        >
            <symbol id="logo-listen-now" viewBox="0 0 240 100" width="40" height="20">
            ...
            <use xlinkHref="#logo-listen-now" x="0" y="0" className={style.listenNowSvg} />

            <g
                id="ctrl-play"
                className={style.playerButtonSvg}
